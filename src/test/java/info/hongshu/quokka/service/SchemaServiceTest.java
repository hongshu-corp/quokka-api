...
import info.hongshu.quokka.schemas.*;
import info.hongshu.quokka.schemas.definitions.*;
...
public class SchemaServiceTest {
    ...
    public class GetEntityClassTest {
        ...
        void should_get_entity() {
            Class<?> aClass = service.getEntityClass("myentity", "info.hongshu.backend.web.service");
    ...
    public class PropertyOrderTest{
        ...
        void should_order_with_the_write_orders() {
            Class<?> aClass = service.getEntityClass("ordered", "info.hongshu.backend.web.service");
            ModelDefinition definition = service.build(aClass);
        ...
        void should_order_with_the_order_definition() {
            Class<?> aClass = service.getEntityClass("specify_order", "info.hongshu.backend.web.service");
            ModelDefinition definition = service.build(aClass);
